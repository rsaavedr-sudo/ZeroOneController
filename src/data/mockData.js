...
// Códigos de área (DDD) de destino.
//  - capital: true  → capital de estado (mostradas no resumo do Dashboard)
//  - capital: false → demais DDDs (visíveis apenas na tela "Ver todas")
const AREAS = [
  // ---- Capitais de estado -------------------------------------------------
  { codigo: '+55 11', pais: 'Brasil', uf: 'SP', regiao: 'São Paulo',      capital: true, asrBase: 64, acdBase: 4.8, volBase: 4200 },
  { codigo: '+55 21', pais: 'Brasil', uf: 'RJ', regiao: 'Rio de Janeiro', capital: true, asrBase: 61, acdBase: 4.6, volBase: 2600 },
  { codigo: '+55 31', pais: 'Brasil', uf: 'MG', regiao: 'Belo Horizonte', capital: true, asrBase: 60, acdBase: 4.5, volBase: 1500, problema: 'intermitente' },
  { codigo: '+55 41', pais: 'Brasil', uf: 'PR', regiao: 'Curitiba',       capital: true, asrBase: 60, acdBase: 4.4, volBase: 1100 },
  { codigo: '+55 51', pais: 'Brasil', uf: 'RS', regiao: 'Porto Alegre',   capital: true, asrBase: 58, acdBase: 4.3, volBase: 980 },
  { codigo: '+55 61', pais: 'Brasil', uf: 'DF', regiao: 'Brasília',       capital: true, asrBase: 57, acdBase: 4.2, volBase: 870 },
  { codigo: '+55 71', pais: 'Brasil', uf: 'BA', regiao: 'Salvador',       capital: true, asrBase: 38, acdBase: 1.3, volBase: 760, problema: 'tecnico' },
  { codigo: '+55 81', pais: 'Brasil', uf: 'PE', regiao: 'Recife',         capital: true, asrBase: 55, acdBase: 4.1, volBase: 720 },
  { codigo: '+55 85', pais: 'Brasil', uf: 'CE', regiao: 'Fortaleza',      capital: true, asrBase: 33, acdBase: 1.5, volBase: 690, problema: 'tecnico' },
  { codigo: '+55 62', pais: 'Brasil', uf: 'GO', regiao: 'Goiânia',        capital: true, asrBase: 58, acdBase: 4.2, volBase: 600 },
  { codigo: '+55 27', pais: 'Brasil', uf: 'ES', regiao: 'Vitória',        capital: true, asrBase: 59, acdBase: 4.2, volBase: 520 },
  { codigo: '+55 92', pais: 'Brasil', uf: 'AM', regiao: 'Manaus',         capital: true, asrBase: 57, acdBase: 4.1, volBase: 540 },
  { codigo: '+55 91', pais: 'Brasil', uf: 'PA', regiao: 'Belém',          capital: true, asrBase: 56, acdBase: 4.0, volBase: 480 },
  { codigo: '+55 48', pais: 'Brasil', uf: 'SC', regiao: 'Florianópolis',  capital: true, asrBase: 49, acdBase: 3.9, volBase: 540 },
  { codigo: '+55 98', pais: 'Brasil', uf: 'MA', regiao: 'São Luís',       capital: true, asrBase: 55, acdBase: 3.9, volBase: 360 },
  { codigo: '+55 84', pais: 'Brasil', uf: 'RN', regiao: 'Natal',          capital: true, asrBase: 55, acdBase: 3.9, volBase: 330 },
  { codigo: '+55 82', pais: 'Brasil', uf: 'AL', regiao: 'Maceió',         capital: true, asrBase: 54, acdBase: 3.8, volBase: 340 },
  { codigo: '+55 83', pais: 'Brasil', uf: 'PB', regiao: 'João Pessoa',    capital: true, asrBase: 56, acdBase: 3.9, volBase: 300 },
  { codigo: '+55 86', pais: 'Brasil', uf: 'PI', regiao: 'Teresina',       capital: true, asrBase: 54, acdBase: 3.8, volBase: 280 },
  { codigo: '+55 79', pais: 'Brasil', uf: 'SE', regiao: 'Aracaju',        capital: true, asrBase: 55, acdBase: 3.8, volBase: 260 },
  { codigo: '+55 65', pais: 'Brasil', uf: 'MT', regiao: 'Cuiabá',         capital: true, asrBase: 57, acdBase: 4.0, volBase: 290 },
  { codigo: '+55 67', pais: 'Brasil', uf: 'MS', regiao: 'Campo Grande',   capital: true, asrBase: 58, acdBase: 4.1, volBase: 300 },
  { codigo: '+55 69', pais: 'Brasil', uf: 'RO', regiao: 'Porto Velho',    capital: true, asrBase: 54, acdBase: 3.7, volBase: 200 },
  { codigo: '+55 95', pais: 'Brasil', uf: 'RR', regiao: 'Boa Vista',      capital: true, asrBase: 52, acdBase: 3.6, volBase: 150 },
  { codigo: '+55 96', pais: 'Brasil', uf: 'AP', regiao: 'Macapá',         capital: true, asrBase: 53, acdBase: 3.7, volBase: 180 },
  { codigo: '+55 68', pais: 'Brasil', uf: 'AC', regiao: 'Rio Branco',     capital: true, asrBase: 53, acdBase: 3.6, volBase: 160 },
  { codigo: '+55 63', pais: 'Brasil', uf: 'TO', regiao: 'Palmas',         capital: true, asrBase: 55, acdBase: 3.8, volBase: 170 },

  // ---- Demais DDDs (interior / regiões metropolitanas) --------------------
  { codigo: '+55 19', pais: 'Brasil', uf: 'SP', regiao: 'Campinas',                capital: false, asrBase: 60, acdBase: 4.5, volBase: 740 },
  { codigo: '+55 13', pais: 'Brasil', uf: 'SP', regiao: 'Santos / Baixada',        capital: false, asrBase: 58, acdBase: 4.3, volBase: 520 },
  { codigo: '+55 12', pais: 'Brasil', uf: 'SP', regiao: 'São José dos Campos',     capital: false, asrBase: 59, acdBase: 4.3, volBase: 430 },
  { codigo: '+55 16', pais: 'Brasil', uf: 'SP', regiao: 'Ribeirão Preto',          capital: false, asrBase: 57, acdBase: 4.2, volBase: 400 },
  { codigo: '+55 17', pais: 'Brasil', uf: 'SP', regiao: 'São José do Rio Preto',   capital: false, asrBase: 56, acdBase: 4.1, volBase: 320 },
  { codigo: '+55 22', pais: 'Brasil', uf: 'RJ', regiao: 'Campos dos Goytacazes',   capital: false, asrBase: 53, acdBase: 3.9, volBase: 300 },
  { codigo: '+55 24', pais: 'Brasil', uf: 'RJ', regiao: 'Volta Redonda / Petrópolis', capital: false, asrBase: 54, acdBase: 3.9, volBase: 290 },
  { codigo: '+55 32', pais: 'Brasil', uf: 'MG', regiao: 'Juiz de Fora',            capital: false, asrBase: 56, acdBase: 4.0, volBase: 310 },
  { codigo: '+55 34', pais: 'Brasil', uf: 'MG', regiao: 'Uberlândia',              capital: false, asrBase: 58, acdBase: 4.2, volBase: 360 },
  { codigo: '+55 43', pais: 'Brasil', uf: 'PR', regiao: 'Londrina',                capital: false, asrBase: 57, acdBase: 4.1, volBase: 330 },
  { codigo: '+55 44', pais: 'Brasil', uf: 'PR', regiao: 'Maringá',                 capital: false, asrBase: 57, acdBase: 4.1, volBase: 290 },
  { codigo: '+55 45', pais: 'Brasil', uf: 'PR', regiao: 'Foz do Iguaçu / Cascavel', capital: false, asrBase: 36, acdBase: 1.4, volBase: 270, problema: 'tecnico' },
  { codigo: '+55 47', pais: 'Brasil', uf: 'SC', regiao: 'Joinville / Blumenau',    capital: false, asrBase: 59, acdBase: 4.3, volBase: 380 },
  { codigo: '+55 54', pais: 'Brasil', uf: 'RS', regiao: 'Caxias do Sul',           capital: false, asrBase: 56, acdBase: 4.0, volBase: 260 },
]
